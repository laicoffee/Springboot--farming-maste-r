...
public class ArticleController {
    ...
    @ResponseBody
    public void addcomment(HttpServletRequest request, HttpSession session, HttpServletResponse response) throws IOException {
        ...
        name = judge.getName();
        System.out.println("我在测试addcoment方法"+name);
